//! Minimal notes server using the SolidMCP framework
//!
//! This demonstrates the new minimal API that reduces boilerplate significantly
...
async fn main() -> Result<()> {
    ...
    let mut server = McpServerBuilder::new(context, "minimal-notes-server", "0.1.0")
        .with_tool(
            "add_note",
    ...
    info!("🚀 Starting minimal notes server on port {}", port);
